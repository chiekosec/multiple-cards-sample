...
const Checkout = ({ location }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const data = await stripe.confirmCardSetup(location.state, {
    ...
    if (data.error) {
      ...
      await fetch("/set-default", {
        ...
        body: JSON.stringify({
          pm: data.setupIntent.payment_method,
        }),
      }).then((r) => r.json());
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit} className="checkout-form">
        ...
        <label>
          Country
          {/* <input type="text" required name='country' value={country} onChange={(e) => setCountry(e.target.value)} /> */}
          <select
            id="country"
            name="country"
            required
